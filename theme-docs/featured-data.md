...
| Setting | What it does |
|---|---|
| **Data block variant** | The visual style of this data block: Primary (larger, featured) or Secondary (smaller, supporting). |
| **Small text** | A small label shown above the data value, for example "Years in business" or "Happy customers". |
| **Data text** | The main number for this data counter, for example 15 or 98. |
| **Data symbol** | A short character shown after the number, for example %, +, or k. |
| **Heading** | The heading or label for this block element. |
| **Subheading** | A short supporting text displayed below the main value or heading in this block. |
| **Choose from library** | A decorative illustration from the built-in library shown alongside the data counter. |
| **Illustration color** | The color applied to the built-in illustration. |
| **Or choose custom image** | The image displayed in this section. Click to upload or select from your media library. |
