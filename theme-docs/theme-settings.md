...
|---|---|
| **Color Schemes** | The set of color palettes available in this theme. Each palette defines background, text, button, and link colors. Sections select which palette to use. |
...
| **Price highlight** | A highlight color applied to product prices across the store, used to draw attention to the price. |

## Logo

Configure your store logo and favicon.
...
| Setting | What it does |
|---|---|
| **Global rounded setting** | A global border radius setting that controls the roundness of section blocks. |
| **Cards border radius** | The border radius applied to product and content cards. |
| **Buttons rounded setting** | The border radius applied to buttons. |
| **Cards border radius (px)** | A fine-grained border radius value for cards in pixels. Use this for precise control when the preset options are not granular enough. |
| **Buttons border radius (px)** | A fine-grained border radius value for buttons in pixels. |
...
| **Page side gutter** | The horizontal padding on either side of the page content, in pixels. |
| **Border thickness** | The thickness of borders applied globally to cards and elements. |

## Buttons

Configures border thickness for outlined buttons across the store.

| Setting | What it does |
|---|---|
| **Border thickness** | The border thickness for outlined buttons, in pixels. |
...
| Setting | What it does |
|---|---|
| **Animations on scroll** | When enabled, sections fade and slide into view as the visitor scrolls down the page. |
...
Enables and styles the Dynamic Island, a floating announcement element that follows the visitor as they scroll down the page.

| Setting | What it does |
|---|---|
| **Enable Dynamic Island** | Enables the Dynamic Island element, a floating announcement bar that follows the visitor as they scroll. |
| **Border color** | The color of the Dynamic Island border. |
| **Border thickness** | The thickness of the Dynamic Island border in pixels. |
| **Border radius** | The corner radius of the Dynamic Island shape in pixels. |
| **Top offset** | The distance from the top of the viewport to the Dynamic Island element, in pixels. |
...
Stores the URLs for your social media profiles. Icons linking to these profiles appear automatically wherever social media icons are enabled across the theme, including the footer and the mobile navigation drawer.

| Setting | What it does |
|---|---|
| **Facebook** | Your Facebook page URL, for example `https://facebook.com/yourstore`. |
| **X / Twitter** | Your X (formerly Twitter) profile URL. |
...
| **Tumblr** | Your Tumblr blog URL. |
| **LinkedIn** | Your LinkedIn company page URL. |
| **Vimeo** | Your Vimeo channel URL. |
| **Threads** | Your Threads profile URL. |
| **WhatsApp** | Your WhatsApp business number or link. |
| **Discord** | Your Discord server invite URL. |
| **Twitch** | Your Twitch channel URL. |
| **Messenger** | Your Facebook Messenger link. |
| **Telegram** | Your Telegram channel or contact URL. |
| **Show email sharing** | When enabled, adds an option for visitors to share pages via email. |
