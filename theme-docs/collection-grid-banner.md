...
|---|---|
| **Show collection title** | Shows the collection name as a heading in the banner. |
...
| **Text size** | The font size of the scrolling text. |
| **Text speed** | Controls how fast the scrolling text moves. Lower values are faster. |
| **Text direction** | The direction in which the text scrolls: Forward (left to right) or Reverse (right to left). |
