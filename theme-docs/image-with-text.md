...
| **Mobile image** | A separate image used on mobile screens. If left blank, the main image is used. Recommended for images that do not crop well to portrait orientation. |
| **Image position** | Controls the overall visual layout of the section. |
| **Image height** | Controls the height of the image column. Adapt uses the natural height of the uploaded image. |
| **Desktop image width** | Controls how wide the image column is relative to the text column on desktop. |
| **Content alignments** | Controls the horizontal alignment of the text column on desktop. |
| **Content alignments (mobile)** | Controls the horizontal alignment of the text column on mobile. |
| **Desktop content position** | Controls the vertical position of the text block within the section on desktop: Top, Middle, or Bottom. |
...
| Setting | What it does |
|---|---|
| **Button text** | The label on this button. Leave blank to hide it. |
