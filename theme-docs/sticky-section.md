...
|---|---|
| **Product** | The product whose images appear in the sticky column of the section. |
| **Custom image** | A custom image for the sticky side of the section. If left blank, the product images are used. |
