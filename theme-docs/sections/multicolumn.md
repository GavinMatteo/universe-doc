...
| **Text alignment (desktop)** | The horizontal alignment of text inside column cards on desktop. |
| **Text alignment (mobile)** | The horizontal alignment of text inside column cards on mobile. |
