...
| **Scrolling text** | The text that repeats in the scrolling marquee. |
| **Enable scroll** | Enables the scrolling text marquee that runs through the section. |
| **Scrolling direction** | Controls the direction of the scrolling text. Forward scrolls left to right, Reverse scrolls right to left. |
| **Speed** | Controls how fast the scrolling text moves. Lower values are faster. |
