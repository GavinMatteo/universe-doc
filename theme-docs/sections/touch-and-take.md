...
| **Mobile image** | A separate image for mobile. If left blank, the desktop image is used. |
...
| **Hotspot color** | The color of the hotspot circle marker on the shoppable image. |
| **Horizontal position** | The horizontal position of the hotspot as a percentage (0 is the left edge, 100 is the right edge). |
| **Vertical position** | The vertical position of the hotspot as a percentage (0 is the top, 100 is the bottom). |
| **Horizontal position** | The horizontal hotspot position on mobile, set independently from desktop. |
| **Vertical position** | The vertical hotspot position on mobile, set independently from desktop. |
