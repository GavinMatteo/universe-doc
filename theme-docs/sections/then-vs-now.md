...
|---|---|
| **Section height** | Controls how tall the section appears on desktop. Choose from preset options. |
| **Section height (mobile)** | Controls how tall the section appears on mobile. |
...
| **Heading** | The main heading displayed at the top of this block or section. |
| **Text color** | The color of the label text overlaid on this side of the before-and-after slider. |
