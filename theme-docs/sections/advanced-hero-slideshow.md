...
| **Image height (desktop)** | Controls how tall the image appears in this section. |
| **Image height (mobile)** | Controls how tall the image appears on mobile. Can be set independently from desktop. |
...
| Setting | What it does |
|---|---|
| **Block color palette** | Applies a color palette to this section, controlling the background, text, and button colors. Color palettes are defined in Theme Settings. |
