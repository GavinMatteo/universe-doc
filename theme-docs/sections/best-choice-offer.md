...
| **Feature 1** | The first feature bullet point shown on this product card. |
| **Feature 2** | The second feature bullet point. |
| **Feature 3** | The third feature bullet point. |
...
| **Product** | The product to feature in this section. Select it from your store's product catalog. |
| **Product image** | A custom image to display for this product instead of its default product image. |
| **Scrolling text** | Text that scrolls in a marquee behind or alongside the product card. |
| **Label** | A short promotional label shown on the highlighted product card, for example "Best seller" or "Our pick". |
| **Label text color** | The text color of the promotional label. |
| **Label background** | The background color of the promotional label. |
| **Feature 1** | The first feature bullet point shown on this product card. |
| **Feature 2** | The second feature bullet point. |
| **Feature 3** | The third feature bullet point. |
| **Feature 4** | The fourth feature bullet point. |
