...
| **Content position** | Controls the vertical position of the content block within the section. |
| **Choose image** | An optional image displayed alongside the contact form. |
...
Not without custom code. The form fields are fixed at the Shopify platform level.
