...
| Setting | What it does |
|---|---|
| **Choose from library** | The icon to display in this block. Choose from the built-in icon library. |
| **Custom image** | A custom image to use as the icon instead of a library option. SVG or PNG with transparent background recommended. |
| **Heading** | The heading or label for this block element. |
| **Paragraph** | Supporting text displayed below the icon and title. |
