...
| **Desktop slide width** | How wide each slide is as a percentage of the viewport on desktop. Lower values reveal more of neighboring slides. |
...
| Setting | What it does |
|---|---|
| **Choose product** | The product to feature in this section. Select it from your store's product catalog. |
| **Short description** | A short description displayed alongside the product in this carousel slide. |
| **Choose image** | A custom image to display for this product instead of its default product image. |
